  ...
  return (
    <div>
      ...
      <div className='input-container'>
        ...
        <input aria-label='dollarSqft' value={price} onChange={(e: any) => handlePrice(e)} className='swdc-rounded-sm swdc-border-[1.5px] swdc-border-black/40 swdc-p-1 swdc-font-bold swdc-outline-none focus:swdc-border-black/100' />
      </div>
      <div className='input-container'>
